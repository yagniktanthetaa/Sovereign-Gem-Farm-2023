<template>
  ...
  <div class="mb-10 flex justify-center">
    <!-- <button
      class="button-style transition ease-in-out delay-150 text-white bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"
  ...
  <div class="flex items-stretch">
    ...
    <div class="m-2 flex flex-col justify-center items-center">
      ...
      <button
        :disabled="vaultLocked"
        class="button-style mr-5 mb-2 transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"
        @click="moveNFTsFE(false)"
      >
        Move to Vault
      </button>
      ...
      <div class="mt-5">
        <button
          :disabled="vaultLocked"
          class="button-style mr-5 mt-2 transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"
          :left="true"
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    //   // }
    //   selectedWalletNFTs.value.map(async (nft) => {
    //     const creator = new PublicKey(
    //       //todo currently simply taking the 1st creator
    //       (nft.onchainMetadata as any).data.creators[0].address
    //     );
    //     console.log('creator is', creator.toBase58());
    //     await depositGem(nft.mint, nft.pubkey!, creator);
    //   });
